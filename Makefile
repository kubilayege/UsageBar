...
test: build
	...
	swiftc -D REGRESSION_TESTS -parse-as-library $$(rg --files Sources -g '*.swift') $$(rg --files Tests -g '*.swift' -g '!ProviderSelectionRegression.swift') -lsqlite3 -o .build/behavior-regression
