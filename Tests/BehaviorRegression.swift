...
struct BehaviorRegression {
    @MainActor static func main() async throws {
        ...
        await updates.testRateLimitedAPIUsesPublicReleaseAndRespectsRetryTime()
        await updates.testOldTimestampAndFailedCheckDoNotMeanNoRelease()
        await updates.testNoReleaseRequiresSuccessfulCheck()
        await updates.testSuccessfulAPICheckKeepsReleaseNotesAndMatchingChecksum()
        await updates.testBrokenPublicFallbackIsAnErrorNotNoRelease()
